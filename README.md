...
Incluye un wrapper TypeScript con un asignador de memoria estático personalizado (_scratchpad_) para intercomunicar datos (`Uint8Array` y `string`) a través de la memoria lineal de WASM, sin depender de los bindings/loader de `asc` ni de exports `__new`, usando un runtime minimalista de máximo rendimiento.
...
// → '0x4cab25c654d6ed1e155105f7afa520433266289c95a67a6b67be65980372999c'
